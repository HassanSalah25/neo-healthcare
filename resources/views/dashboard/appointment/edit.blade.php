        ...
        <div class="bg-light rounded h-100 p-4">
            ...
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input  type="text" class="form-control" name="name" id="name" value="{{$appointment->service->name_ar}}" disabled>
                </div>
                <div class="mb-3">
                    <label for="offer_type" class="form-label">Service Category</label>
                    <input  type="text" class="form-control" name="offer_type" id="offer_type" value="{{$appointment->service->service_category->name_ar}}" disabled>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input  type="text" class="form-control" name="price" id="price" value="{{$appointment->time}}" disabled>
                </div>
                <div class="mb-3">
                    <label for="status" class="form-label">Status</label>
                    <select class="form-control" name="status" id="status" disabled>
                            <option value="0" {{$appointment->status == 0 ? "selected" : ""}}>pending</option>
                            <option value="1" {{$appointment->status == 1 ? "selected" : ""}}>Done</option>
                    </select>
                </div>
