...
<div class="card">
    <div class="card-header">
        <h6 class="mb-0">{{ __('Messages of ') }} {{ optional($chatThread->customer)->name }}</h6>
    </div>
    <div class="card-body">
                                ...
                                <div class="chat-coversation d-inline-flex">
                                    <div class="media">
                                        <span class="avatar avatar-xs flex-shrink-0" data-toggle="tooltip" title="{{ $chat->sender->name }}">
                                            <img src="{{ uploaded_asset($chat->sender->avatar)}}" onerror="this.onerror=null;this.src='{{ asset('assets/img/avatar-place.png') }}';">
                                        </span>
            ...
            <div class="chat-footer border-top p-3 attached-bottom bg-white">
                <form id="send-mesaage" onsubmit="send_reply(event)">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="message" id="message" placeholder="{{ __('Your Message..') }}" autocomplete="off">
