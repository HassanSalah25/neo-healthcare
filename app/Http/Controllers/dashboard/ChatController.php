...
class ChatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.chats.index', compact('chat_threads'));
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.chats.show', compact('chatThread'));
    }
    ...
    public function refresh(Request $request)
    {
        ...
        return [
            'view' => view('dashboard.chats.refresh', compact('chats'))->render(),
